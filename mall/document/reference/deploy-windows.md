...
- 启动项目：右击com.xavi.mall.MallAdminApplication的main方法，选择run as Java Application
...
- 创建配置文件：mongodb\mongod.cfg
    ...
    ```
- 安装为服务（运行命令需要用管理员权限）：D:\developer\mongodb-win32-x86_64-windows-5.0.31\bin\mongod.exe --config "D:\developer\mongodb-win32-x86_64-windows-5.0.31\mongod.cfg" --install
...
- 启动项目：直接运行com.xavi.mall.MallAdminApplication的main方法即可
- 接口文档地址：http://localhost:8080/swagger-ui.html

## mall-search

- 启动项目：直接运行com.xavi.mall.search.MallSearchApplication的main方法即可
...
- 启动mall-portal项目：直接运行com.xavi.mall.portal.MallPortalApplication的main方法即可
