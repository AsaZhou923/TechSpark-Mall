<template>
	<view class="container">
		...
		<view class="carousel-section">
			...
			<swiper class="carousel" circular @change="swiperChange" :indicator-dots="true" indicator-color="rgba(255,255,255,0.4)" indicator-active-color="#ffffff">
		...
		<view class="f-header m-t" @click="navToNewProudctListPage()">
			...
			<view class="tit-box">
				...
				<text class="tit2">为你寻觅最新电子产品</text>
			</view>
		...
		<view class="f-header m-t" @click="navToRecommendBrandPage()">
			...
			<view class="tit-box">
				<text class="tit">电子品牌制造商直供</text>
				<text class="tit2">优质电子产品，工厂直达消费者</text>
			</view>
			<text class="yticon icon-you"></text>
		</view>
...
<style lang="scss">
	...
	page {
		.cate-section {
			position: relative;
			z-index: 5;
			border-radius: 20upx 20upx 0 0;  /* 增加圆角 */
			margin-top: -20upx;
			box-shadow: 0 -5upx 20upx rgba(0,0,0,0.05);  /* 添加阴影 */
		}
